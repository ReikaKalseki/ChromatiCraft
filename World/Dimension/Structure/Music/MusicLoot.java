...
public class MusicLoot extends StructurePiece {

	public MusicLoot(DimensionStructureGenerator s) {
		super(s);
	}
	...
	private void generateAir(ChunkSplicedGenerationCache world, int x, int y, int z) {
		world.setBlock(x+1, y+1, z+1, STRUCTURE_AIR);
		...
		world.setBlock(x+1, y+2, z+1, STRUCTURE_AIR);
		...
		world.setBlock(x+1, y+3, z+1, STRUCTURE_AIR);
		...
		world.setBlock(x+2, y+1, z+0, STRUCTURE_AIR);
		...
		world.setBlock(x+2, y+2, z+0, STRUCTURE_AIR);
		...
		world.setBlock(x+2, y+3, z+0, STRUCTURE_AIR);
		world.setBlock(x+2, y+3, z+1, STRUCTURE_AIR);
		...
		world.setBlock(x+3, y+1, z+0, STRUCTURE_AIR);
		...
		world.setBlock(x+3, y+2, z+0, STRUCTURE_AIR);
		...
		world.setBlock(x+3, y+3, z+0, STRUCTURE_AIR);
		world.setBlock(x+3, y+3, z+1, STRUCTURE_AIR);
		...
		world.setBlock(x+4, y+1, z+0, STRUCTURE_AIR);
		...
		world.setBlock(x+4, y+2, z+0, STRUCTURE_AIR);
		...
		world.setBlock(x+4, y+3, z+0, STRUCTURE_AIR);
		world.setBlock(x+4, y+3, z+1, STRUCTURE_AIR);
		...
		world.setBlock(x+5, y+3, z+1, STRUCTURE_AIR);
