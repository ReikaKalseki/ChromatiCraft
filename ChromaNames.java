...
public class ChromaNames {
	...
	public static final String[] fluidNames = {
		"fluid.chroma", "fluid.endere", "fluid.potioncrystal", "fluid.luma", "fluid.lumen"
	};
	...
	public static final String[] craftingNames = {
		...
		"chromacraft.voiddust", "chromacraft.livingessence", "chromacraft.lumencore", "chromacraft.glowchunk"
	};
	...
	public static final String[] dimGenNames = {
		...
		"chromaitem.dimgen.geode", "chromaitem.dimgen.crysleaf", "chromaitem.dimgen.oceanstone", "chromaitem.dimgen.cliffshard"
	};
