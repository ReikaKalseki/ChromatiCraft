...
public class ChromaStructures {
	...
	public static FilledBlockArray getPortalStructure(World world, int x, int y, int z, boolean display) {
		...
		array.setBlock(i+0, j+3, k+0, b);
		array.setBlock(i+0, j+3, k+1, b);
		array.setBlock(i+0, j+3, k+2, b);
		array.setBlock(i+0, j+3, k+3, b);
		array.setBlock(i+0, j+3, k+4, b);
		...
		array.setBlock(i+0, j+3, k+10, b);
		array.setBlock(i+0, j+3, k+11, b);
		array.setBlock(i+0, j+3, k+12, b);
		array.setBlock(i+0, j+3, k+13, b);
		array.setBlock(i+0, j+3, k+14, b);
		...
		array.setBlock(i+2, j+3, k+12, b);
		array.setBlock(i+2, j+3, k+13, ch, 1);
		array.setBlock(i+2, j+3, k+14, b);
		...
		array.setBlock(i+11, j+3, k+14, b);
		...
		array.setBlock(i+13, j+3, k+14, b);
		...
		array.setBlock(i+14, j+3, k+0, b);
		array.setBlock(i+14, j+3, k+1, b);
		array.setBlock(i+14, j+3, k+2, b);
		array.setBlock(i+14, j+3, k+3, b);
		array.setBlock(i+14, j+3, k+4, b);
		...
		array.setBlock(i+14, j+3, k+10, b);
		array.setBlock(i+14, j+3, k+11, b);
		array.setBlock(i+14, j+3, k+12, b);
		array.setBlock(i+14, j+3, k+13, b);
		array.setBlock(i+14, j+3, k+14, b);
