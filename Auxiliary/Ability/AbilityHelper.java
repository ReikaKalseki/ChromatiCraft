...
public class AbilityHelper implements AbilityAPI {
	...
	private final MultiMap<Ability, ProgressStage> progressMap = new MultiMap(CollectionType.HASHSET);
	private final MultiMap<Ability, CrystalElement> structureMap = new MultiMap(CollectionType.HASHSET);
