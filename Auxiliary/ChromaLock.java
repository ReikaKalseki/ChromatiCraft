...
public final class ChromaLock implements IPlayerTracker {
	...
	private static String getMessage() {
		...
		sb.append("NOTICE: It has been detected that third-party plugins are being used to disable parts of ChromatiCraft.\n");
		sb.append("This is frequently done to sell access to mod content, and is against the Terms of Use.\n");
		sb.append("All ChromatiCraft functionality is temporarily disabled, and will be restored if the disables are removed.\n");
