...
public enum ChromaResearch implements ProgressElement, ProgressAccess {
	...
	ASPECT(			ChromaTiles.ASPECT, 		ResearchLevel.ENERGY),
	...
	BOOKDECOMP(		ChromaTiles.BOOKDECOMP,		ResearchLevel.ENERGY),
	...
	EXCAVATOR(			ChromaItems.EXCAVATOR, 		ResearchLevel.ENERGY),
	TRANSITION(			ChromaItems.TRANSITION, 	ResearchLevel.ENERGY),
	INVLINK(			ChromaItems.LINK, 			ResearchLevel.ENERGY),
	PENDANT(			ChromaItems.PENDANT, 		ResearchLevel.ENERGY),
