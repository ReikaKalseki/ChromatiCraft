...
public class GuiMIDIDisc extends GuiScreen {
	...
	public void updateScreen() {
		...
		if (input.getText().isEmpty()) {
			...
			file = input.getText();
		//packet removed ReikaPacketHelper.sendStringPacket(ChromatiCraft.packetChannel, ChromaPackets.MUSICDISC.ordinal(), file);
	}
	...
	public void drawScreen(int x, int y, float f)
	{
		...
		ReikaGuiAPI.instance.drawCenteredStringNoShadow(fontRendererObj, "Select a MIDI file. Be sure to include", posX+xSize/2+1, posY+4, 4210752);
