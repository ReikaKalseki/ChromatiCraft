...
public class RenderWirelessSource extends ChromaRenderBase {
	...
	private void drawInner(TileEntityWirelessSource te) {
		...
		int t = te.isInWorld() ? te.getTicksExisted() : Math.abs((int)(System.currentTimeMillis()/50));
		int c = CrystalElement.getBlendedColor(t, 25);
